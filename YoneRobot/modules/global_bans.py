...
def gban(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("uff... u trying to ban me ?\n go and study noob!")
        return
...
def ungban(update: Update, context: CallbackContext):
    ...
    message.reply_text(f"I'll give {user_chat.first_name}  give second chance \ntold he/she never do anything wrong again.")
