...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://te.legra.ph/file/fc2c8a24eecaacdb996e8.jpg), Iam komi a anime theme based group management bot .
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add komi to your group ➕️", url="t.me/?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [komi ](https://telegra.ph/file/082096b101615e33eaf19.jpg) 
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

yone_IMG = "https://te.legra.ph/file/aa5fd711c7f428f7ed453.jpg"
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *komi*, a powerful group management bot built to help you manage your group easily.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *komi*
                 \nHere is the [Source Code](https://github.com/Aarukami/komiXrobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "me back let's do party")
        except Unauthorized:
            LOGGER.warning(
